...
function App() {
  ...
  const handleLogout = async () => {
    try {
      await fetch('http://130.131.225.98:5000/api/auth/logout', {
        method: 'POST'
      });
    } catch (error) {
...
function StaffManagement({ user }) {
  ...
  const fetchStaff = async () => {
    try {
      ...
      const response = await fetch('http://130.131.225.98:5000/api/staff', { headers });
  ...
  const fetchBranches = async () => {
    try {
      ...
      const response = await fetch('http://130.131.225.98:5000/api/branches', { headers });
      if (response.ok) {
        const data = await response.json();
...
function StaffForm({ staff, branches, onSave, onCancel }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = staff
        ? `http://130.131.225.98:5000/api/staff/${staff.staff_id}`
        : 'http://130.131.225.98:5000/api/staff';
...
function Members() {
  ...
  useEffect(() => {
    ...
    fetch('http://130.131.225.98:5000/api/members', { headers })
      .then(res => res.json())
      .then(data => {
...
function Loans({ user }) {
  ...
  useEffect(() => {
    ...
    fetch('http://130.131.225.98:5000/api/loans', { headers })
      .then(res => res.json())
      .then(data => {
        setLoans(data.data || []);
        setLoading(false);
                  ...
                  <Button
                    ...
                    onClick={async () => {
                      try {
                        ...
                        const response = await fetch(`http://130.131.225.98:5000/api/loans/${loan.loan_id}`, {
                          method: 'DELETE',
                          headers
                        });
...
function Fines({ user }) {
  ...
  useEffect(() => {
    ...
    fetch('http://130.131.225.98:5000/api/fines', { headers })
      .then(res => res.json())
      .then(data => {
        setFines(data || []);
        setLoading(false);
                  ...
                  <Button
                    ...
                    onClick={async () => {
                      try {
                        ...
                        const response = await fetch(`http://130.131.225.98:5000/api/fines/${fine.fine_id}`, {
                          method: 'PATCH',
                          headers,
                        ...
                        if (response.ok) {
                          // Refresh fines list
                          const finesResponse = await fetch('http://130.131.225.98:5000/api/fines', { headers });
